...
rpmbuild -bb  --rmsource *.spec --without lvs --without perf --without perftool --without dracut --without debug --define="_rpmdir $1/rpm" --define="_builddir $1/taobao-kernel-build" --define="_sourcedir $1/taobao-kernel-build" --define="_tmppath $1/rpm"
